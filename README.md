...
自带 llama.cpp 官方对话页面，打开就能聊天；本地同时提供兼容 OpenAI 格式的 `/v1` 接口，可以对接任意第三方客户端。
...
- 服务启动后内置官方对话页面，代码块一键复制，外部链接会用系统浏览器打开跳转
...
| **前端页面** | React 19 · TypeScript · Vite 6 · Tailwind CSS 4 | 现代化响应式单页界面 |
...
4. 直接切换到**对话**面板开始聊天；也可以通过本地地址 `http://127.0.0.1:8080/v1` 对接其他软件
