import { Check, Copy, ListChecks, MoreHorizontal, Pencil, Plus, Star, Trash2 } from "lucide-react";
...
export default function ProfilesPage({ models, onEdit, onDelete, onDuplicate, onSetDefault, onReorderProfile, onDeleteProfiles }: {
  ...
  const create = () => { if (model && !allMode) onEdit(model.id, { ...DEFAULT_PROFILES[0], id: uid("profile"), name: "新运行预设", description: "自定义 llama.cpp 启动参数" }); };
